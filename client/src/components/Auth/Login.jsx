    ...
    return (
      <div className="p-5 bg-[#c2c5ff] text-[#152250] flex flex-col items-center justify-center gap-5 rounded border-2 border-gray-800 shadow-lg w-[35%]">
        ...
        >
          ...
          <button className="oauthButton w-full">
          ...
          <button className="oauthButton flex items-center justify-center gap-2 w-full">
            <svg className="w-6 h-6" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-center gap-2 w-full">
            ...
            <span className="text-#152250 font-mono font-semibold">OR</span>
            <div className="w-24 h-1 bg-[#152250] rounded" />
          </div>
          ...
          <input
            ...
            placeholder="Email"
            className="w-full h-12 px-4 rounded-lg border-2 border-[#152250] bg-white shadow-md font-semibold outline-none"
          />
